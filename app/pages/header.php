...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="bottle, caps, collection, database, beer, personal">
        <meta name="description" content="Personal collection of bottle caps">
        <meta name="author" content="Mikołaj Pięcek">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
        <link rel="stylesheet" href="styles/style.css">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
        <script src='scripts/min/search_suggestions.min.js'></script>
        <title><?=$title?></title>
    </head>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <form method='GET' action='collection' class="form-inline my-2 my-lg-0" autocomplete="off">
                    <select name='field' class="form-control mr-sm-2 mb-2 mb-md-0">
                        ...
                        <option value='brand' <?=getExists('field', 'brand', 'selected')?>>Brand</option>
                        <option value='text' <?=getExists('field', 'text', 'selected')?>>Text</option>
                        <option value='country' <?=getExists('field', 'country', 'selected')?>>Country</option>
                    </select>

                    <div class='form-group search-container mr-2 my-2 my-sm-0'>
                        <input class="form-control" type="search" name="search" placeholder="Search" value="<?=getValue('search');?>">
