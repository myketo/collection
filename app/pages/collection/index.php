<div class="collection-page d-flex flex-column">
    ...
    <form class='shadow p-3 m-1 bg-white rounded d-flex flex-column justify-content-end col-lg-2 col-md-3 align-self-end position-absolute' style='z-index: 1000;'>
        <div class='form-row'>
